...
3.  [Overwrite,overload，override 区别](#Overwrite,overload，override 区别)
4.  [继承-子类，父类](#继承-子类，父类)
5.  [接口、抽象类的区别](#接口、抽象类的区别)
6.  [多线程实现方式](#多线程实现方式)
7.  [synchronized、volatile、Lock](#synchronized、volatile、Lock)
8.  [Exception 和 Error的区别](#Exception 和 Error的区别)
9.  [集合区别 ArrayList ,linkList ,集合有哪些（）list Map set](#集合区别 ArrayList ,linkList ,集合有哪些（）list Map set)
10.  [String， StringBuilder ,Stringbuffer 区别](#String， StringBuilder ,Stringbuffer 区别)
